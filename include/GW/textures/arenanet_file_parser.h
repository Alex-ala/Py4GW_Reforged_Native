...
// ArenaNet File Format (FFNA) Parser. Migrated verbatim from the legacy
// ArenaNetFileParser; used to locate inline texture chunks and to read raw
// asset bytes out of the GW.dat archive. Grouped under the textures module.
