...
namespace GW::Context {
    ...
    typedef GW::GwList<VisibleEffect> VisibleEffectList;
    ...
    struct Equipment {
        ...
        /* +h0010 */ GW::Context::ItemData* reft_hand_ptr;   // Ptr Bow, Hammer, Focus, Daggers, Scythe
        /* +h0014 */ GW::Context::ItemData* right_hand_ptr;  // Ptr Sword, Spear, Staff, Daggers, Axe, Zepter, Bundle
        /* +h0018 */ uint32_t h0018;            // 
        /* +h001C */ GW::Context::ItemData* shield_ptr;      // Ptr Shield
        ...
        union {
            /* +h0024 */ GW::Context::ItemData items[9];
            struct {
                /* +h0024 */ GW::Context::ItemData weapon;
                /* +h0034 */ GW::Context::ItemData offhand;
                /* +h0044 */ GW::Context::ItemData chest;
                /* +h0054 */ GW::Context::ItemData legs;
                /* +h0064 */ GW::Context::ItemData head;
                /* +h0074 */ GW::Context::ItemData feet;
                /* +h0084 */ GW::Context::ItemData hands;
                /* +h0094 */ GW::Context::ItemData costume_body;
                /* +h00A4 */ GW::Context::ItemData costume_head;
            };
        };
        union {
    ...
    struct Agent {
        ...
        /* +h001C */ GW::GwLink<Agent> link;
        /* +h0024 */ GW::GwLink<Agent> link2;
