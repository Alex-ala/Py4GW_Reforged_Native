...
namespace GW::Context {
    ...
    struct Bag { // total: 0x28/40
        /* +h0000 */ GW::Context::BagType bag_type;
        ...
        bool IsInventoryBag()       const { return bag_type == GW::Context::BagType::Inventory; }
        bool IsStorageBag()         const { return bag_type == GW::Context::BagType::Storage; }
        bool IsMaterialStorage()    const { return bag_type == GW::Context::BagType::MaterialStorage; }
